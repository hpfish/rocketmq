...
public class NamesrvConfig {
    ...
    /**
     * RocketMQ 主目录,可以通过-Drocketmq.home.dir=path 或 通过设置环境变量 ROCKETMQ_HOME 来配置 RocketMQ的主目录
     */
    ...
    /**
     * nameServer 默认配置文件路径,不生效。 nameServer启动时如果通过配置文件配置 NameServer启动属性的话，请使用-c选项
     */
